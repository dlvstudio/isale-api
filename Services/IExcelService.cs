...
public interface IExcelService
{
    ...
    Task<string> CreateSalesReportFile(int reportType, string lang, string userId, DateTime? dateFrom, DateTime? dateTo, int storeId, int staffId);
    ...
    Task<OrderReportSummaryViewModel> BuildSalesReportByOrder(string lang, string userId, DateTime? dateFrom, DateTime? dateTo, int storeId, int staffId);
    Task<OrderReportSummaryViewModel> BuildSalesReportByProduct(string lang, string userId, DateTime? dateFrom, DateTime? dateTo, int storeId, int staffId);
    Task<OrderReportSummaryViewModel> BuildSalesReportByCustomerAndProduct(string lang, string userId, DateTime? dateFrom, DateTime? dateTo, int storeId, int staffId);
    Task<OrderReportSummaryViewModel> BuildSalesReportByStaff(string lang, string userId, DateTime? dateFrom, DateTime? dateTo, int storeId, int staffId);
    Task<ProductReportViewModel> BuildProductReportSummary(string lang, string userId, DateTime? dateFrom, DateTime? dateTo, int storeId);
