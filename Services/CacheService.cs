...
public class CacheService : ICacheService
{
    ...
    public Dictionary<string, IEnumerable<Dictionary<string, object>>> GetListEqualItem(string table, string userId)
    {
        ...
        _memoryCache.TryGetValue<Dictionary<string, IEnumerable<Dictionary<string, object>>>>(LISTEQUAL + "-" + table + "-" + userId, out value);
        return value;
    }
    ...
    {
        object value = null;
        return _memoryCache.TryGetValue(LISTEQUAL + "-" + table + "-" + userId, out value);
    }

    public bool GetByIdContains(string table, string userId, int id)
    {
        return _tableItemCache.Contains(table, userId, id);
    }
